import { c as create_ssr_component, a as compute_rest_props, b as spread, d as escape_object, e as escape_attribute_value, v as validate_component, f as add_attribute, j as compute_slots, k as each, g as getContext, h as escape, m as missing_component } from "./ssr.js";
import { T as ToolbarButton } from "./ToolbarButton.js";
import { B as Button } from "./Button.js";
import { P as Popper, a as Popover, D as Dropdown, b as DropdownItem, C as ChevronDownOutline } from "./ChevronDownOutline.js";
import { twMerge } from "tailwind-merge";
import { D as DownloadSolid } from "./DownloadSolid.js";
import { U as Users } from "./users.js";
import { i as imagesPath } from "./variables.js";
import { A as Avatar, I as Indicator } from "./Avatar.js";
import { N as Navbar, b as NavHamburger, a as NavBrand, c as NavUl, d as NavLi, D as DarkMode } from "./NavUl.js";
import { W as Wrapper, I as Input } from "./Input.js";
/* empty css    */
...
const AnnotationSolid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path fill-rule="evenodd" d="M3.559 4.544c.355-.35.834-.544 1.33-.544H19.11c.496 0 .975.194 1.33.544.356.35.559.829.559 1.331v9.25c0 .502-.203.981-.559 1.331-.355.35-.834.544-1.33.544H15.5l-2.7 3.6a1 1 0 0 1-1.6 0L8.5 17H4.889c-.496 0-.975-.194-1.33-.544A1.868 1.868 0 0 1 3 15.125v-9.25c0-.502.203-.981.559-1.331ZM7.556 7.5a1 1 0 1 0 0 2h8a1 1 0 0 0 0-2h-8Zm0 3.5a1 1 0 1 0 0 2H12a1 1 0 1 0 0-2H7.556Z" clip-rule="evenodd"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: escape_attribute_value(color) },
      escape_object($$restProps),
...
const BellSolid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path d="M17.133 12.632v-1.8a5.406 5.406 0 0 0-4.154-5.262.955.955 0 0 0 .021-.106V3.1a1 1 0 0 0-2 0v2.364a.955.955 0 0 0 .021.106 5.406 5.406 0 0 0-4.154 5.262v1.8C6.867 15.018 5 15.614 5 16.807 5 17.4 5 18 5.538 18h12.924C19 18 19 17.4 19 16.807c0-1.193-1.867-1.789-1.867-4.175ZM8.823 19a3.453 3.453 0 0 0 6.354 0H8.823Z"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: escape_attribute_value(color) },
      escape_object($$restProps),
...
const CameraPhotoOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$restProps = compute_rest_props($$props, ["size", "role", "color", "withEvents", "title", "strokeWidth", "desc", "ariaLabel"]);
  const ctx = getContext("iconCtx") ?? {};
  const sizes = {
    xs: "w-3 h-3",
  ...
  let ariaDescribedby = `${title.id || ""} ${desc.id || ""}`;
  let hasDescription = false;
  let { ariaLabel = "camera photo outline" } = $$props;
  if ($$props.size === void 0 && $$bindings.size && size !== void 0) $$bindings.size(size);
  if ($$props.role === void 0 && $$bindings.role && role !== void 0) $$bindings.role(role);
  if ($$props.color === void 0 && $$bindings.color && color !== void 0) $$bindings.color(color);
  if ($$props.withEvents === void 0 && $$bindings.withEvents && withEvents !== void 0) $$bindings.withEvents(withEvents);
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linejoin="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M4 18V8a1 1 0 0 1 1-1h1.5l1.707-1.707A1 1 0 0 1 8.914 5h6.172a1 1 0 0 1 .707.293L17.5 7H19a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1Z"></path><path stroke="currentColor" stroke-linejoin="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      { color: escape_attribute_value(color) },
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linejoin="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M4 18V8a1 1 0 0 1 1-1h1.5l1.707-1.707A1 1 0 0 1 8.914 5h6.172a1 1 0 0 1 .707.293L17.5 7H19a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1Z"></path><path stroke="currentColor" stroke-linejoin="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"></path></svg>`} `;
});
...
const EyeSolid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path fill-rule="evenodd" d="M4.998 7.78C6.729 6.345 9.198 5 12 5c2.802 0 5.27 1.345 7.002 2.78a12.713 12.713 0 0 1 2.096 2.183c.253.344.465.682.618.997.14.286.284.658.284 1.04s-.145.754-.284 1.04a6.6 6.6 0 0 1-.618.997 12.712 12.712 0 0 1-2.096 2.183C17.271 17.655 14.802 19 12 19c-2.802 0-5.27-1.345-7.002-2.78a12.712 12.712 0 0 1-2.096-2.183 6.6 6.6 0 0 1-.618-.997C2.144 12.754 2 12.382 2 12s.145-.754.284-1.04c.153-.315.365-.653.618-.997A12.714 12.714 0 0 1 4.998 7.78ZM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" clip-rule="evenodd"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: escape_attribute_value(color) },
      escape_object($$restProps),
...
const HeartSolid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path d="m12.75 20.66 6.184-7.098c2.677-2.884 2.559-6.506.754-8.705-.898-1.095-2.206-1.816-3.72-1.855-1.293-.034-2.652.43-3.963 1.442-1.315-1.012-2.678-1.476-3.973-1.442-1.515.04-2.825.76-3.724 1.855-1.806 2.201-1.915 5.823.772 8.706l6.183 7.097c.19.216.46.34.743.34a.985.985 0 0 0 .743-.34Z"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: escape_attribute_value(color) },
      escape_object($$restProps),
...
const InboxOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M4 13h3.439a.991.991 0 0 1 .908.6 3.978 3.978 0 0 0 7.306 0 .99.99 0 0 1 .908-.6H20M4 13v6a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-6M4 13l2-9h12l2 9"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      { color: escape_attribute_value(color) },
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M4 13h3.439a.991.991 0 0 1 .908.6 3.978 3.978 0 0 0 7.306 0 .99.99 0 0 1 .908-.6H20M4 13v6a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-6M4 13l2-9h12l2 9"></path></svg>`} `;
});
const ProfileCardOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M15 9h3m-3 3h3m-3 3h3m-6 1c-.306-.613-.933-1-1.618-1H7.618c-.685 0-1.312.387-1.618 1M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm7 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      { color: escape_attribute_value(color) },
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M15 9h3m-3 3h3m-3 3h3m-6 1c-.306-.613-.933-1-1.618-1H7.618c-.685 0-1.312.387-1.618 1M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm7 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"></path></svg>`} `;
});
const SalePercentOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"${add_attribute("stroke-width", strokeWidth, 0)} d="M8.891 15.107 15.11 8.89m-5.183-.52h.01m3.089 7.254h.01M14.08 3.902a2.849 2.849 0 0 0 2.176.902 2.845 2.845 0 0 1 2.94 2.94 2.849 2.849 0 0 0 .901 2.176 2.847 2.847 0 0 1 0 4.16 2.848 2.848 0 0 0-.901 2.175 2.843 2.843 0 0 1-2.94 2.94 2.848 2.848 0 0 0-2.176.902 2.847 2.847 0 0 1-4.16 0 2.85 2.85 0 0 0-2.176-.902 2.845 2.845 0 0 1-2.94-2.94 2.848 2.848 0 0 0-.901-2.176 2.848 2.848 0 0 1 0-4.16 2.849 2.849 0 0 0 .901-2.176 2.845 2.845 0 0 1 2.941-2.94 2.849 2.849 0 0 0 2.176-.901 2.847 2.847 0 0 1 4.159 0Z"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      { color: escape_attribute_value(color) },
...
const IconAvatar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { src = "" } = $$props;
  let { color = "dark" } = $$props;
  if ($$props.src === void 0 && $$bindings.src && src !== void 0) $$bindings.src(src);
  if ($$props.color === void 0 && $$bindings.color && color !== void 0) $$bindings.color(color);
  return `${validate_component(Avatar, "Avatar").$$render($$result, { size: "none", class: "h-11 w-11" }, {}, {
    default: () => {
      return `<img alt=""${add_attribute("src", imagesPath(src, "users"), 0)} class="rounded-full"> ${validate_component(Indicator, "Indicator").$$render(
        $$result,
        {
          placement: "bottom-right",
          class: "h-5 w-5 translate-y-0",
          color
        },
        {},
        {
...
const Notification = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.when === void 0 && $$bindings.when && when !== void 0) $$bindings.when(when);
  if ($$props.href === void 0 && $$bindings.href && href !== void 0) $$bindings.href(href);
  if ($$props.color === void 0 && $$bindings.color && color !== void 0) $$bindings.color(color);
  return `<a${add_attribute("href", href, 0)} class="flex gap-2 border-b px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">${validate_component(IconAvatar, "IconAvatar").$$render($$result, { src, color }, {}, {
    default: () => {
      return `${icon ? `${validate_component(icon || missing_component, "svelte:component").$$render(
        $$result,
        {
          size: "xs",
          class: "text-gray-50 dark:text-white"
        },
        {},
        {}
      )}` : ``}`;
    }
  })} <div class="w-full pl-3"><div class="mb-1.5 text-sm font-normal text-gray-500 dark:text-gray-400">${slots.default ? slots.default({}) : ``}</div> ${when ? `<div class="text-xs font-medium text-primary-700 dark:text-primary-400">${escape(when)}</div>` : ``}</div></a>`;
});
const NotificationList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(ToolbarButton, "ToolbarButton").$$render(
    ...
    {
      default: () => {
        return `${validate_component(BellSolid, "BellSolid").$$render($$result, { size: "lg" }, {}, {})}`;
      }
    }
    ...
    {
      title: () => {
        return `<div slot="title" class="rounded text-center" data-svelte-h="svelte-wy2lro">Notifications</div>`;
      },
      default: () => {
        return `<div class="bg-50 dark:bg-gray-700">${validate_component(Notification, "Notification").$$render(
          $$result,
          {
            href: "#",
            src: Users[0].avatar,
          ...
          {
            default: () => {
              return `New message from <span class="font-semibold text-gray-900 dark:text-white" data-svelte-h="svelte-1h4vu88">Bonnie Green</span>
          ...
          {
            default: () => {
              return `<span class="font-semibold text-gray-900 dark:text-white" data-svelte-h="svelte-gbxprg">Jese leos</span> and
			<span class="font-medium text-gray-900 dark:text-white" data-svelte-h="svelte-1f9b5ui">5 others</span> started following you.`;
            }
          }
        )} ${validate_component(Notification, "Notification").$$render(
          $$result,
          ...
          {
            default: () => {
              return `<span class="font-semibold text-gray-900 dark:text-white" data-svelte-h="svelte-4ifnsu">Joseph Mcfall</span> and
			<span class="font-medium text-gray-900 dark:text-white" data-svelte-h="svelte-omk30j">141 others</span> love your story. See
          ...
          {
            default: () => {
              return `<span class="font-semibold text-gray-900 dark:text-white" data-svelte-h="svelte-jcu27l">Leslie Livingston</span>
			mentioned you in a comment:
			<span class="font-medium text-primary-700 dark:text-primary-500" data-svelte-h="svelte-zq02k6">@bonnie.green</span> what do you
			say?`;
            }
          }
        )} ${validate_component(Notification, "Notification").$$render(
          ...
          {
            default: () => {
              return `<span class="font-semibold text-gray-900 dark:text-white" data-svelte-h="svelte-9ynewq">Robert Brown</span> posted a new video:
          ...
          {
            default: () => {
              return `${validate_component(EyeSolid, "EyeSolid").$$render($$result, {}, {}, {})}
		View all`;
            }
          }
        )}`;
    ...
    {},
    {
      default: ({ NavContainer }) => {
        return `${validate_component(NavHamburger, "NavHamburger").$$render(
          ...
          {},
          {}
        )} ${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/", style: "min-width:450px;" }, {}, {
          default: () => {
            return `<img src="/images/flowbite-svelte-icon-logo.svg" style="width=350px;" class="me-2.5 h-6 sm:h-8" alt="Flowbite Logo">`;
          }
          ...
          {},
          {
            default: () => {
              return `${validate_component(NavLi, "NavLi").$$render($$result, { href: "/" }, {}, {
                ...
                default: () => {
                  return `Dropdown
					${validate_component(ChevronDownOutline, "ChevronDownOutline").$$render($$result, { class: "ms-0 inline" }, {}, {})}`;
                }
        ...
        )}` : `<form>${validate_component(Search, "Search").$$render(
          $$result,
          {
            size: "md",
          ...
          {},
          {}
        )}</form>`}</div> <div class="ms-auto flex items-center text-gray-500 dark:text-gray-400 sm:order-2">${validate_component(NotificationList, "Notifications").$$render($$result, {}, {}, {})} ${validate_component(AppsMenu, "AppsMenu").$$render($$result, {}, {}, {})} ${validate_component(DarkMode, "DarkMode").$$render($$result, {}, {}, {})} ${validate_component(UserMenu, "UserMenu").$$render($$result, Object.assign({}, Users[4]), {}, {})}</div>`;
      }
    }
  )}`;
});
