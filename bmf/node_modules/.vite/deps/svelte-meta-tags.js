...
function create_if_block_21(ctx) {
  ...
  function select_block_type(ctx2, dirty) {
    ...
    if (dirty[0] & /*openGraph*/
    64) show_if_3 = null;
    if (show_if == null) show_if = !!/*openGraph*/
    (ctx2[6].type.toLowerCase() === "profile" && /*openGraph*/
    ctx2[6].profile);
    if (show_if) return create_if_block_22;
    if (show_if_1 == null) show_if_1 = !!/*openGraph*/
    (ctx2[6].type.toLowerCase() === "book" && /*openGraph*/
    ctx2[6].book);
    if (show_if_1) return create_if_block_27;
    if (show_if_2 == null) show_if_2 = !!/*openGraph*/
    (ctx2[6].type.toLowerCase() === "article" && /*openGraph*/
    ctx2[6].article);
    if (show_if_2) return create_if_block_32;
    if (show_if_3 == null) show_if_3 = !!/*openGraph*/
    ...
    ctx2[6].video);
    if (show_if_3) return create_if_block_39;
  }
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      if_block6_anchor = empty();
      if (if_block7) if_block7.l(head_nodes);
      if_block7_anchor = empty();
      if (if_block8) if_block8.l(head_nodes);
      if_block8_anchor = empty();
      if (if_block9) if_block9.l(head_nodes);
      if_block9_anchor = empty();
      if (if_block10) if_block10.l(head_nodes);
      if_block10_anchor = empty();
    ...
    m: function mount(target, anchor) {
      ...
      if (if_block9) if_block9.m(document.head, null);
      append_hydration_dev(document.head, if_block9_anchor);
      if (if_block10) if_block10.m(document.head, null);
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty[0] & /*additionalMetaTags*/
      512) show_if = /*additionalMetaTags*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot") console_1.warn(`<MetaTags> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("title" in $$props2) $$invalidate(13, title = $$props2.title);
    if ("titleTemplate" in $$props2) $$invalidate(14, titleTemplate = $$props2.titleTemplate);
    if ("robots" in $$props2) $$invalidate(0, robots = $$props2.robots);
    if ("additionalRobotsProps" in $$props2) $$invalidate(15, additionalRobotsProps = $$props2.additionalRobotsProps);
    if ("description" in $$props2) $$invalidate(1, description = $$props2.description);
    if ("mobileAlternate" in $$props2) $$invalidate(2, mobileAlternate = $$props2.mobileAlternate);
    if ("languageAlternates" in $$props2) $$invalidate(3, languageAlternates = $$props2.languageAlternates);
    if ("twitter" in $$props2) $$invalidate(4, twitter = $$props2.twitter);
    if ("facebook" in $$props2) $$invalidate(5, facebook = $$props2.facebook);
    if ("openGraph" in $$props2) $$invalidate(6, openGraph = $$props2.openGraph);
    if ("canonical" in $$props2) $$invalidate(7, canonical = $$props2.canonical);
    if ("keywords" in $$props2) $$invalidate(8, keywords = $$props2.keywords);
    if ("additionalMetaTags" in $$props2) $$invalidate(9, additionalMetaTags = $$props2.additionalMetaTags);
    if ("additionalLinkTags" in $$props2) $$invalidate(10, additionalLinkTags = $$props2.additionalLinkTags);
  };
  $$self.$capture_state = () => ({
    title,
    titleTemplate,
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("additionalMetaTags" in $$props2) $$invalidate(9, additionalMetaTags = $$props2.additionalMetaTags);
    if ("additionalLinkTags" in $$props2) $$invalidate(10, additionalLinkTags = $$props2.additionalLinkTags);
    if ("robotsParams" in $$props2) $$invalidate(11, robotsParams = $$props2.robotsParams);
    if ("updatedTitle" in $$props2) $$invalidate(12, updatedTitle = $$props2.updatedTitle);
  };
...
function instance2($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot") console.warn(`<JsonLd> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("output" in $$props2) $$invalidate(0, output = $$props2.output);
    if ("schema" in $$props2) $$invalidate(3, schema = $$props2.schema);
  };
  $$self.$capture_state = () => ({
    output,
    schema,
  ...
  $$self.$inject_state = ($$props2) => {
    if ("output" in $$props2) $$invalidate(0, output = $$props2.output);
    if ("schema" in $$props2) $$invalidate(3, schema = $$props2.schema);
    if ("json" in $$props2) $$invalidate(1, json = $$props2.json);
    if ("isValid" in $$props2) $$invalidate(2, isValid = $$props2.isValid);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
